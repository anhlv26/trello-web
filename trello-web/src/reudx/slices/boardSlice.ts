...
import { Board, Card, Column } from "~/types/type";
        ...
        cards: [
          {
            ...
            cover:
              "https://th.bing.com/th/id/OIP.dq9GSbgc8CicDlghovRhywHaEX?rs=1&pid=ImgDetMain",
...
const boardSlice = createSlice({
  ...
  initialState,
  reducers: {
    setOrderedColumns(state, action: PayloadAction<Column[]>) {
